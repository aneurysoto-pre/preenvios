 ...
 * cada corredor tiene blog dedicado + 1 wiki cat:'corredor' + 2 wikis
 * compartidos + lista de top operators.
 */
...
// ─────────────────────────────────────────────────────────────────────
// WIKI LINKS — 17 entries, una por cada artículo de WIKI_ARTICLES.
// Incluye los 3 wikis dedicados de SV/CO/MX agregados por la branch
// feat/landing-editorial-5-corredores (paridad 100% por corredor MVP).
// ─────────────────────────────────────────────────────────────────────
export const WIKI_LINKS: Record<string, { corredores: string[]; operadores: string[] }> = {
  ...
  // Por corredor (6 — 1 dedicado por cada corredor MVP)
...
// ─────────────────────────────────────────────────────────────────────
// CORRIDOR → BLOGS — 1 blog dedicado por cada corredor MVP
// ─────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────
// CORRIDOR → WIKIS — 1 wiki dedicado + 2 wikis compartidos por corredor
// ─────────────────────────────────────────────────────────────────────
