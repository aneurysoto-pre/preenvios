...
export const WIKI_ARTICLES = [
  ...
  // Slug nuevo (era 'elegir-remesadora-segun-monto') — alineado al frontmatter del .md publicado.
  ...
  // Métodos de envío (categoría nueva 2026-04-25)
  // Slug nuevo (era 'cash-pickup-vs-banco') — alineado al frontmatter del .md publicado.
