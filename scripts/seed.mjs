...
const operadores = {
  ...
  westernunion: { nombre: 'Western Union',  rating: 4.5, reviews: 15820, afiliado: false, confiabilidad: 95, metodos_disponibles: 3 },
  moneygram:    { nombre: 'MoneyGram',      rating: 4.4, reviews: 7541,  afiliado: false, confiabilidad: 85, metodos_disponibles: 3 },
}
...
const precios = [
  ...
  { operador: 'westernunion', corredor: 'honduras',           tasa: 26.10, fee: 0,    velocidad: 'Minutos',  link: '' },
  { operador: 'moneygram',    corredor: 'honduras',           tasa: 25.95, fee: 1.99, velocidad: 'Horas',    link: '' },
  // DOMINICAN REPUBLIC
  ...
  { operador: 'westernunion', corredor: 'dominican_republic', tasa: 59.20, fee: 0,    velocidad: 'Minutos',  link: '' },
  { operador: 'moneygram',    corredor: 'dominican_republic', tasa: 58.50, fee: 1.99, velocidad: 'Horas',    link: '' },
  // GUATEMALA
  ...
  { operador: 'westernunion', corredor: 'guatemala',          tasa: 7.52,  fee: 0,    velocidad: 'Minutos',  link: '' },
  { operador: 'moneygram',    corredor: 'guatemala',          tasa: 7.48,  fee: 1.99, velocidad: 'Horas',    link: '' },
  ...
  { operador: 'westernunion', corredor: 'el_salvador',        tasa: 1,     fee: 5.00, velocidad: 'Minutos',  link: '' },
  { operador: 'moneygram',    corredor: 'el_salvador',        tasa: 1,     fee: 1.99, velocidad: 'Horas',    link: '' },
]
